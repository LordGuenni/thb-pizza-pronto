...
public class CustomerVO extends PersonVO {
	...
	public CustomerVO(String lastName, String firstName, String street, int houseNumber, Gender gender,LocalDate dateOfBirth) {
	...
	public String toString() {
		...
		s.append("Gender: " + this.getGender().toString() + "\n");
