...
//		});
		...
		removeButton.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				IOrdering ordering = getSelectedOrder();
...
//							frame.setLocationRelativeTo(null);
		...
		printButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				IOrdering ordering = getSelectedOrder();
				OrderVO order = ((Ordering) ordering).getCurrentOrder();
	...
	private void updateShoppingBasket(IOrdering ordering) {
		OrderVO order = ((Ordering) ordering).getCurrentOrder();
...
//			new ExceptionPanel(ex);
	...
	private void displayOrderDetails(IOrdering ordering) {
		
		OrderVO order = ((Ordering) ordering).getCurrentOrder();
		CustomerVO customer = ((Ordering) ordering).getCurrentCustomer();		
	...
	private IOrdering getSelectedOrder() {
		IOrdering ordering = new Ordering();
